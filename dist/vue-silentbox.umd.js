(function (global, factory) {
    ...
    var script = {
      ...
      methods: {
         ...
         * @return {void}
         */
        removeIconClick: function removeIconClick() {
        ...
        openSilentBoxOverlay: function openSilentBoxOverlay() {
          ...
          var itemIndex = this.$parent.items.list.findIndex(
            function (item) { return item.src === this$1.src; }
          );
            ...
            ? _c("div", {
                ...
                on: {
                  click: function($event) {
                    ...
                    return _vm.removeIconClick($event)
                  }
                }
              })
            : _vm._e()
    ...
    __vue_render__._withStripped = true;
      ...
      var __vue_inject_styles__ = function (inject) {
        if (!inject) { return }
        inject("data-v-3b3a6a2d_0", { source: ".silentbox-item {\n  position: relative;\n  cursor: pointer;\n  text-decoration: underline;\n  vertical-align: top;\n}\n.silentbox-item .remove-icon {\n  color: white;\n  cursor: pointer;\n  height: 1rem;\n  position: absolute;\n  right: 2px;\n  top: 0px;\n  transition: 250ms ease;\n  width: 1rem;\n}\n.silentbox-item .remove-icon:before, .silentbox-item .remove-icon:after {\n  background: white;\n  content: \"\";\n  height: 2px;\n  left: 5%;\n  position: absolute;\n  top: 50%;\n  transition: 250ms ease;\n  width: 100%;\n}\n.silentbox-item .remove-icon:before {\n  transform: rotate(-45deg);\n}\n.silentbox-item .remove-icon:after {\n  transform: rotate(45deg);\n}\n.silentbox-item .remove-icon:hover:before, .silentbox-item .remove-icon:hover:after, .silentbox-item .remove-icon:focus:before, .silentbox-item .remove-icon:focus:after {\n  background: red;\n}\n\n/*# sourceMappingURL=item.vue.map */", map: {"version":3,"sources":["c:\\laragon\\www\\coachsome\\silentbox\\components\\item.vue","item.vue"],"names":[],"mappings":"AAsHA;EACA,kBAAA;EACA,eAAA;EACA,0BAAA;EACA,mBAAA;ACrHA;ADuHA;EACA,YATA;EAUA,eAAA;EACA,YAAA;EACA,kBAAA;EACA,UAAA;EACA,QAAA;EACA,sBAAA;EACA,WAAA;ACrHA;ADsHA;EAEA,iBAnBA;EAoBA,WAAA;EACA,WAAA;EACA,QAAA;EACA,kBAAA;EACA,QAAA;EACA,sBAAA;EACA,WAAA;ACrHA;ADuHA;EACA,yBAAA;ACrHA;ADuHA;EACA,wBAAA;ACrHA;ADyHA;EAEA,eArCA;ACnFA;;AAEA,mCAAmC","file":"item.vue","sourcesContent":["<template>\r\n  <span class=\"silentbox-item\" :src=\"src\" @click=\"openSilentBoxOverlay\">\r\n    <slot>\r\n      <img :src=\"getThumnail(src)\" :width=\"thumbnailWidth\" :height=\"thumbnailHeight\" />\r\n    </slot>\r\n    <div v-if=\"removeable\" class=\"remove-icon\" @click.stop=\"removeIconClick\"></div>\r\n  </span>\r\n</template>\r\n\r\n<script>\r\nimport ItemMixin from \"./../mixins/item\";\r\n\r\nexport default {\r\n  name: \"SilentboxItem\",\r\n  mixins: [ItemMixin],\r\n  props: {\r\n    // Media source, it could be an image or a youtube video.\r\n    src: {\r\n      type: String,\r\n      required: true\r\n    },\r\n    // True if video should be autoplayed.\r\n    autoplay: {\r\n      type: Boolean,\r\n      default() {\r\n        return false;\r\n      }\r\n    },\r\n    // Short description below image.\r\n    description: String,\r\n    position: {},\r\n    thumbnailWidth: {\r\n      type: String,\r\n      default: \"200px\"\r\n    },\r\n    thumbnailHeight: {\r\n      type: String,\r\n      default: \"150px\"\r\n    },\r\n    // Hide player controls\r\n    hideControls: {\r\n      type: Boolean,\r\n      default() {\r\n        return false;\r\n      }\r\n    },\r\n    // Remove icon controls\r\n    removeable: {\r\n      type: Boolean,\r\n      default() {\r\n        return false;\r\n      }\r\n    }\r\n  },\r\n  computed: {\r\n    /**\r\n     * Get embed URL.\r\n     * @return {string|null}\r\n     */\r\n    embedUrl() {\r\n      if (this.src !== null) {\r\n        return this.src;\r\n      }\r\n\r\n      return null;\r\n    }\r\n  },\r\n  methods: {\r\n    /**\r\n     * Emit an event when click remove icon.\r\n     *\r\n     * @return {void}\r\n     */\r\n    removeIconClick() {\r\n      this.$emit(\"removeIconClicked\");\r\n    },\r\n    /**\r\n     * Emit an event that overlay should be hidden.\r\n     *\r\n     * @return {void}\r\n     */\r\n    closeSilentBoxOverlay() {\r\n      this.$parent.$emit(\"closeSilentboxOverlay\");\r\n    },\r\n    /**\r\n     * Emit an event that overlay should be opened.\r\n     *\r\n     * @return {void}\r\n     */\r\n    openSilentBoxOverlay() {\r\n      let itemIndex = this.$parent.items.list.findIndex(\r\n        item => item.src === this.src\r\n      );\r\n\r\n      this.$parent.$emit(\"openSilentboxOverlay\", {\r\n        url: this.embedUrl,\r\n        position: itemIndex,\r\n        autoplay: this.autoplay,\r\n        description: this.description\r\n      });\r\n    }\r\n  },\r\n  created() {\r\n    // Push items to the parent component.\r\n    // TODO: do it in parent component\r\n    this.$parent.items.list.push({\r\n      src: this.src,\r\n      autoplay: this.autoplay,\r\n      desc: this.description,\r\n      position: this.position\r\n    });\r\n  }\r\n};\r\n</script>\r\n\r\n<style lang=\"scss\">\r\n$icon-color: white;\r\n$accent: red;\r\n.silentbox-item {\r\n  position: relative;\r\n  cursor: pointer;\r\n  text-decoration: underline;\r\n  vertical-align: top;\r\n\r\n  .remove-icon {\r\n    color: $icon-color;\r\n    cursor: pointer;\r\n    height: 1rem;\r\n    position: absolute;\r\n    right: 2px;\r\n    top: 0px;\r\n    transition: 250ms ease;\r\n    width: 1rem;\r\n    &:before,\r\n    &:after {\r\n      background: $icon-color;\r\n      content: \"\";\r\n      height: 2px;\r\n      left: 5%;\r\n      position: absolute;\r\n      top: 50%;\r\n      transition: 250ms ease;\r\n      width: 100%;\r\n    }\r\n    &:before {\r\n      transform: rotate(-45deg);\r\n    }\r\n    &:after {\r\n      transform: rotate(45deg);\r\n    }\r\n    &:hover,\r\n    &:focus {\r\n      &:before,\r\n      &:after {\r\n        background: $accent;\r\n      }\r\n    }\r\n  }\r\n}\r\n</style>",".silentbox-item {\n  position: relative;\n  cursor: pointer;\n  text-decoration: underline;\n  vertical-align: top;\n}\n.silentbox-item .remove-icon {\n  color: white;\n  cursor: pointer;\n  height: 1rem;\n  position: absolute;\n  right: 2px;\n  top: 0px;\n  transition: 250ms ease;\n  width: 1rem;\n}\n.silentbox-item .remove-icon:before, .silentbox-item .remove-icon:after {\n  background: white;\n  content: \"\";\n  height: 2px;\n  left: 5%;\n  position: absolute;\n  top: 50%;\n  transition: 250ms ease;\n  width: 100%;\n}\n.silentbox-item .remove-icon:before {\n  transform: rotate(-45deg);\n}\n.silentbox-item .remove-icon:after {\n  transform: rotate(45deg);\n}\n.silentbox-item .remove-icon:hover:before, .silentbox-item .remove-icon:hover:after, .silentbox-item .remove-icon:focus:before, .silentbox-item .remove-icon:focus:after {\n  background: red;\n}\n\n/*# sourceMappingURL=item.vue.map */"]}, media: undefined });
    ...
    var __vue_render__$3 = function() {
      ...
      return _c(
        "section",
        {
          class: { "masonry-layout": _vm.masonryLayout },
    ...
    __vue_render__$3._withStripped = true;
      ...
      var __vue_inject_styles__$3 = function (inject) {
        if (!inject) { return }
        inject("data-v-5fe94454_0", { source: "/* Masonry on large screens */\n@media only screen and (min-width: 1024px) {\n.masonry-layout[data-v-5fe94454] {\n    column-count: 4;\n    column-gap: 1em;\n}\n}\n/* Masonry on medium-sized screens */\n@media only screen and (max-width: 1023px) and (min-width: 768px) {\n.masonry-layout[data-v-5fe94454] {\n    column-count: 3;\n    column-gap: 1em;\n}\n}\n/* Masonry on small screens */\n@media only screen and (max-width: 767px) and (min-width: 540px) {\n.masonry-layout[data-v-5fe94454] {\n    column-count: 2;\n    column-gap: 1em;\n}\n}\n\n/*# sourceMappingURL=group.vue.map */", map: {"version":3,"sources":["c:\\laragon\\www\\coachsome\\silentbox\\components\\group.vue","group.vue"],"names":[],"mappings":"AAQA,6BAAA;AACA;AACA;IACA,eAAA;IACA,eAAA;ACPE;AACF;ADUA,oCAAA;AACA;AACA;IACA,eAAA;IACA,eAAA;ACRE;AACF;ADWA,6BAAA;AACA;AACA;IACA,eAAA;IACA,eAAA;ACTE;AACF;;AAEA,oCAAoC","file":"group.vue","sourcesContent":["<template>\r\n  <section id=\"silentbox-group\" :class=\"{'masonry-layout': masonryLayout}\">\r\n    <slot></slot>\r\n    <silentbox-overlay></silentbox-overlay>\r\n  </section>\r\n</template>\r\n\r\n<style scoped lang=\"scss\">\r\n/* Masonry on large screens */\r\n@media only screen and (min-width: 1024px) {\r\n  .masonry-layout {\r\n    column-count: 4;\r\n    column-gap: 1em;\r\n  }\r\n}\r\n\r\n/* Masonry on medium-sized screens */\r\n@media only screen and (max-width: 1023px) and (min-width: 768px) {\r\n  .masonry-layout {\r\n    column-count: 3;\r\n    column-gap: 1em;\r\n  }\r\n}\r\n\r\n/* Masonry on small screens */\r\n@media only screen and (max-width: 767px) and (min-width: 540px) {\r\n  .masonry-layout {\r\n    column-count: 2;\r\n    column-gap: 1em;\r\n  }\r\n}\r\n</style>\r\n\r\n<script>\r\nimport overlay from \"./overlay.vue\";\r\n\r\nexport default {\r\n  name: \"SilentboxGroup\",\r\n  props: {\r\n    // Masonry layout\r\n    masonryLayout: {\r\n      type: Boolean,\r\n      default() {\r\n        return false;\r\n      }\r\n    }\r\n  },\r\n  data() {\r\n    return {\r\n      overlayVisibility: false,\r\n      embedUrl: \"\",\r\n      items: {\r\n        total: 0,\r\n        position: 0,\r\n        list: []\r\n      },\r\n      autoplay: false,\r\n      description: \"\"\r\n    };\r\n  },\r\n  watch: {\r\n    /**\r\n     * Update total number of items when object changes.\r\n     *\r\n     * @param  {Object} current\r\n     * @param  {Object} old\r\n     * @return {void}\r\n     */\r\n    \"items.list\": function(current, old) {\r\n      this.updateTotal(current);\r\n    }\r\n  },\r\n  methods: {\r\n    /** \r\n     * Update count of total items in group.\r\n     *\r\n     * @param  {object} items\r\n     * @return {void}\r\n     */\r\n    updateTotal(items) {\r\n      this.items.total = this.items.list.length;\r\n    },\r\n    /**\r\n     * Move to next item in a group.\r\n     *\r\n     * @return {void}\r\n     */\r\n    nextItem() {\r\n      if (this.items.position !== this.items.total - 1) {\r\n        this.items.position++;\r\n      } else {\r\n        this.items.position = 0;\r\n      }\r\n\r\n      this.embedUrl = this.items.list[this.items.position].src;\r\n\r\n      this.autoplay =\r\n        this.items.list[this.items.position].autoplay !== undefined\r\n          ? this.items.list[this.items.position].autoplay\r\n          : false;\r\n\r\n      this.description =\r\n        this.items.list[this.items.position].desc !== undefined\r\n          ? this.items.list[this.items.position].desc\r\n          : false;\r\n    },\r\n    /**\r\n     * Move to previous item in a group.\r\n     *\r\n     * @return {void}\r\n     */\r\n    prevItem() {\r\n      if (this.items.position !== 0) {\r\n        this.items.position--;\r\n      } else {\r\n        this.items.position = this.items.total - 1;\r\n      }\r\n\r\n      this.embedUrl = this.items.list[this.items.position].src;\r\n\r\n      this.autoplay =\r\n        this.items.list[this.items.position].autoplay !== undefined\r\n          ? this.items.list[this.items.position]\r\n          : false;\r\n\r\n      this.description =\r\n        this.items.list[this.items.position].desc !== undefined\r\n          ? this.items.list[this.items.position].desc\r\n          : false;\r\n    },\r\n    /**\r\n     * Set item that shuld be displayed.\r\n     *\r\n     * @return {void}\r\n     */\r\n    setOpened(item) {\r\n      this.embedUrl = item.url;\r\n      this.items.position = item.position;\r\n      this.overlayVisibility = true;\r\n      this.autoplay = item.autoplay;\r\n      this.description = item.description;\r\n    }\r\n  },\r\n  components: {\r\n    \"silentbox-overlay\": overlay\r\n  },\r\n  mounted() {\r\n    // Hide overlay when user click outside or on close button.\r\n    this.$on(\"closeSilentboxOverlay\", () => {\r\n      this.overlayVisibility = false;\r\n    });\r\n\r\n    // Set first opened item when overlay opens.\r\n    this.$on(\"openSilentboxOverlay\", item => {\r\n      this.setOpened(item);\r\n    });\r\n\r\n    // Update total number of available items in group.\r\n    this.updateTotal(this.items);\r\n\r\n    // Listen to key events.\r\n    window.addEventListener(\"keyup\", event => {\r\n      // Escape: 27\r\n      if (event.which === 27) {\r\n        this.overlayVisibility = false;\r\n      }\r\n      // Right arrow: 39\r\n      if (event.which === 39) {\r\n        this.nextItem();\r\n      }\r\n      // Left arrow: 37\r\n      if (event.which === 37) {\r\n        this.prevItem();\r\n      }\r\n    });\r\n  }\r\n};\r\n</script>","/* Masonry on large screens */\n@media only screen and (min-width: 1024px) {\n  .masonry-layout {\n    column-count: 4;\n    column-gap: 1em;\n  }\n}\n/* Masonry on medium-sized screens */\n@media only screen and (max-width: 1023px) and (min-width: 768px) {\n  .masonry-layout {\n    column-count: 3;\n    column-gap: 1em;\n  }\n}\n/* Masonry on small screens */\n@media only screen and (max-width: 767px) and (min-width: 540px) {\n  .masonry-layout {\n    column-count: 2;\n    column-gap: 1em;\n  }\n}\n\n/*# sourceMappingURL=group.vue.map */"]}, media: undefined });

      };
      /* scoped */
      var __vue_scope_id__$3 = "data-v-5fe94454";
      /* module identifier */
